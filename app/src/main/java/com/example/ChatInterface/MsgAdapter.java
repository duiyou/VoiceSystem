...
public class MsgAdapter extends RecyclerView.Adapter {
    ...
    public static class SendViewHolder extends RecyclerView.ViewHolder{
        ...
        public SendViewHolder(@NonNull View itemView) {
            super(itemView);
            mTextView=(TextView)itemView.findViewById(R.id.user_textview);
        }
    }
    //接收信息的ViewHolder
    public static class ReceivedViewHolder extends RecyclerView.ViewHolder{
        ...
        public ReceivedViewHolder(@NonNull View itemView) {
            super(itemView);
            mTextView=(TextView)itemView.findViewById(R.id.robot_textview);
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            case Msg.TYPE_SEND:
                //创建视图
                mView= LayoutInflater.from(parent.getContext()).inflate(R.layout.chatactivity_listuser, parent, false);
                //创建ViewHolder并传入视图
                mViewHolder=new SendViewHolder(mView);
                return mViewHolder;
            case Msg.TYPE_RECEIVED:
                //创建视图
                mView= LayoutInflater.from(parent.getContext()).inflate(R.layout.chatactivity_listrobot, parent, false);
                //创建ViewHolder并传入视图
