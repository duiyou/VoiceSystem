...
public class SpeechRecognitionManager {
    ...
    private static final String TAG = "SpeechRecognitionManage";
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    //e.printStackTrace();
                    Log.d(TAG,"getTokenAndSendVoiceFile获取请求码，线程出错");
                }
            }
        }).start();
    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Log.d(TAG,"sendVoiceFile发送录音文件，查看是否可以获取到网络流");
                    //把文件内容写入流中
                    ...
                    Log.d(TAG,"sendVoiceFile发送录音文件得到识别结果："+responseResult);
                } catch (Exception e) {
                    //e.printStackTrace();
                    Log.d(TAG,"sendVoiceFile发送录音文件出错");
                }
                //reSet初始化
                reSet();
            }
    ...
    private String getResponse(HttpURLConnection connection) throws Exception {
        ...
        Log.d(TAG, "getResponse得到回复所有信息："+response.toString());
        //返回JSON数据
